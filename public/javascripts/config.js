...
const BASE_STAT_DICT = {
    ...
    "Athena":[30000,2,15,700,100,100,2, 3,1,8,1,
      "Aegis","Target within 3 units gains 10 DEF, clears statuses",
      "Deliberate Strike","700 true damage to one target within 8 units",
      "Well-Prepared","Player cards start game with 200MP"], 
    "Apollo":[2000,6,10,700,100,250,3, undefined,undefined,undefined,undefined,
    ...
    "Hestia":[500,3,15,1200,250,50,1, undefined,3,4,2,
      ...
      "Shelter", "All adjacent cards gain 10 DEF, +200 max HP"],
    ...
    "Hera":[1400,2,15,800,100,250,1, undefined,3,4,1,
      "Protector","Grants 10 DEF, 100 HP, 100 MP to ally",
      "Wrath","Enemy card max HP reduced to 100",
