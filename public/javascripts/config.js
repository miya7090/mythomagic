...
const BASE_STAT_DICT = {
    ...
    "Hera":[1400,2,15,800,40,0,2, 2,0,4,0,
      "Blessing","Grant 5 DEF, 200 HP, 100 MP to ally within 2 tiles",
    ...
    "Heracles":[2800,2,15,500,50,0,3, undefined,3,undefined,1,
    ...
    "Hades":[2800,2,10,800,50,0,2, 2,0,undefined,undefined,
    ...
    "Themis":[1400,2,15,800,50,0,2, 3,0,undefined,undefined,
      "Verdict","Revert target within 3 units to their base stats and clear status effects",
      "Fair-Minded","Revert all enemies to their base stats",
