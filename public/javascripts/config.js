...
const BASE_STAT_DICT = {
    ...
    "Artemis":[2500,2,10,700,60,0,3, 5,0,5,2,
    ...
    "Atalanta":[2700,2,10,700,30,0,3, undefined,1,undefined,1,
      "First Blood","Attack all adjacent enemies, dealing an extra 150 true damage to enemies with full HP",
      "Grapple","Inflict Stunned on all adjacent enemies and deal 300 true damage to each",
      "Dismissal","Autoattacks deal an extra 100 true damage to enemies with lesser MVT", "Melee"],
    "Achilles":[2500,2,20,300,30,0,3, undefined,3,undefined,undefined,
      ...
      "Clarity","Clear all statuses, gain 300 ATK when an ally is defeated", "Melee"],
    "Gaea":[1200,2,15,1000,50,0,1, 2,0,undefined,undefined,
      "Rejuvenation","Give 100 HP and 100 MP to ally within 2 tiles",
      "Revitalization", "Give 200 HP to all allies",
    ...
    "Jason":[1800,2,10,800,70,0,2, undefined,undefined,undefined,undefined,
      ...
      "Captainship", "Increase DEF of all allies by 2, decrease DEF of all enemies by 5",
      "Argonautica","All allies gain 100 ATK for each Argonaut in the team", "Protector"],
    "Medea":[1200,2,10,500,70,0,2, 4,0,1,0,
      "Sorcery", "Absorb all mana from an enemy within 4 tiles and inflict Poisoned",
    ...
    "Thanatos":[1800,2,10,600,60,0,3, undefined,2,undefined,undefined,
      "Soul Collection","Attack enemies within 2 tiles, and absorb the MP and 50% of the ATK of any defeated enemies",
      "Reaper","All enemies with less than 200 HP receive 200 true damage",
    ...
    "Heracles":[2700,2,15,500,30,0,3, undefined,3,undefined,1,
    ...
    "Hades":[2300,2,10,800,50,0,2, 2,0,undefined,undefined,
    ...
    "Hecate":[1800,2,10,700,70,0,2, 2,0,undefined,undefined,
    ...
    "Icarus":[400,2,10,700,70,0,1, undefined,undefined,undefined,undefined,
      "Accelerate","Gain 1 MVT, accumulate 20 more MP per turn, and decrease max HP by 50",
    ...
    "Hephaestus":[1800,2,15,800,50,0,2, 5,1,4,2,
      ...
      "Blacksmith","Allies' autoattacks have a 50% chance of dealing an extra 100 true damage", "Supporter"],
    "Eros":[2100,2,10,800,50,0,2, 4,0,undefined,undefined,
    ...
    "Nyx":[1600,2,10,600,60,0,2, 3,0,1,0,
      ...
      "Oblivion","Permanently disable the ability and ultimate of an adjacent enemy",
