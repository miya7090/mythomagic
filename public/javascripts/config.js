...
const BASE_STAT_DICT = {
    ...
    "Athena":[30000,2,15,700,100,100,2, 3,1,8,1,
    ...
    "Apollo":[2000,6,10,700,100,250,3, 6,2,undefined,undefined,
      ...
      "Medicine","+30 HP to all heroes, -30 HP to all enemies after your turn"],
    ...
    "Medea":[1400,2,10,500,100,300,1, 3,1,1,1,
      "Sorcery", "Drain all mana from enemy within 3 tiles and inflict Poisoned",
      "Cold Blood", "Deal fatal blow to adjacent ally, absorb its current ATK, DEF, MVT, and regain full HP",
    ...
    "Poseidon":[4000,2,10,700,100,250,1, undefined,9,undefined,6,
      ...
      "Hurricane","Deal 300 true damage to all targets within 6 tiles",
      "*Aquatic Healing","Gain 100HP per turn while in water"],
    "Thanatos":[2800,4,10,600,100,200,2,undefined,9,undefined,undefined,
    ...
    "Hestia":[500,3,15,1200,250,50,1, undefined,2,undefined,2,
    ...
    "Perseus":[1400,2,10,500,100,250,2, undefined,2,undefined,undefined,
    ...
    "Hera":[1400,2,15,800,100,250,1, 4,1,6,1,
    ...
    "Hermes":[1200,2,10,600,100,250,3, 1,1,undefined,undefined,
    ...
    "Heracles":[3800,2,15,500,100,250,1, undefined,3,undefined,1,
